...
def apply_matplotlib_theme(fig, ax, theme: dict):
    """Menerapkan tema warna & background transparan ke figur Matplotlib."""
...
def page_cluster_analysis():
    ...
    with cnt_col1:
        st.plotly_chart(make_countplot("Store ID", "Distribusi Store ID"), use_container_width=True)
        st.plotly_chart(make_countplot("Region", "Distribusi Region"), use_container_width=True)
        st.plotly_chart(make_countplot("Seasonality", "Distribusi Seasonality"), use_container_width=True)
    with cnt_col2:
        st.plotly_chart(make_countplot("Category", "Distribusi Category", rotate=True), use_container_width=True)
        st.plotly_chart(make_countplot("Weather Condition", "Distribusi Weather Condition"), use_container_width=True)
